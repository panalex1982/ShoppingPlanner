...
public class DatabaseHandler extends SQLiteOpenHelper {
	...
	public ProductGroup getProductGroup(int id) {
		...
		Cursor cursor = db.query(TABLE_PRODUCT_GROUP,
				new String[] { PRODUCT_GROUP_NAME, }, PRODUCT_GROUP_ID + "=?",
	...
	public int updateProductGroup(ProductGroup productGroup) {
		...
		// updating row
		int updateMessage = db.update(TABLE_PRODUCT_GROUP, values,
				PRODUCT_GROUP_ID + " = ?",
	...
	public void addProductKind(ProductKind productKind) {
		...
		ContentValues values = new ContentValues();
		values.put(PRODUCT_KIND_NAME, productKind.getName()); // ProductKind
																// Name
	...
	public ProductKind getProductKind(int id) {
		...
		Cursor cursor = db.query(TABLE_PRODUCT_KIND,
				new String[] { PRODUCT_KIND_NAME,
	...
	public int updateProductKind(ProductKind productKind) {
		...
		// updating row
		int updateMessage = db.update(TABLE_PRODUCT_KIND, values,
				PRODUCT_KIND_ID + " = ?",
	...
	public void addCommercialProduct(CommercialProduct commercialProduct) {
		...
		values.put(COMMERCIAL_PRODUCT_NAME,
				commercialProduct.getCommercialName());
		values.put(COMMERCIAL_PRODUCT_COMPANY_BRAND,
				commercialProduct.getCompanyBrand());
	...
	public CommercialProduct getCommercialProduct(String barcode) {
		...
		Cursor cursor = db.query(TABLE_COMMERCIAL_PRODUCT, new String[] {
				COMMERCIAL_PRODUCT_NAME, COMMERCIAL_PRODUCT_COMPANY_BRAND, },
				COMMERCIAL_PRODUCT_BARCODE + "=?",
	...
	public int updateCommercialProduct(CommercialProduct commercialProduct) {
		...
		int updateMessage = db
				.update(TABLE_COMMERCIAL_PRODUCT, values,
						COMMERCIAL_PRODUCT_BARCODE + " = ?",
						new String[] { String.valueOf(commercialProduct
								.getBarcode()) });
		db.close();
		return updateMessage;
	}
	...
	public void deleteCommercialProduct(CommercialProduct commercialProduct) {
		SQLiteDatabase db = this.getWritableDatabase();
		db.delete(TABLE_COMMERCIAL_PRODUCT,
				COMMERCIAL_PRODUCT_BARCODE + " = ?",
	...
	public Product getProduct(int id) {
		...
		Cursor cursor = db.query(TABLE_PRODUCT, new String[] { PRODUCT_NAME,
				PRODUCT_BARCODE, PRODUCT_KIND, }, PRODUCT_ID + "=?",
				new String[] { String.valueOf(id) }, null, null, null, null);
		if (cursor != null)
			cursor.moveToFirst();
	...
	public ShopDescription getShopDescription(int id) {
		...
		Cursor cursor = db.query(TABLE_SHOP_DESCRIPTION,
				new String[] { SHOP_DESCRIPTION_NAME, }, SHOP_DESCRIPTION_ID
	...
	public int updateShopDescription(ShopDescription shopDescription) {
		...
		// updating row
		int updateMessage = db.update(TABLE_SHOP_DESCRIPTION, values,
				SHOP_DESCRIPTION_ID + " = ?",
	...
	public void addAddress(Address address) {
		...
		values.put(ADDRESS_ZIP, address.getZip());
	...
	public Address getAddress(int id) {
		...
		Cursor cursor = db.query(TABLE_ADDRESS, new String[] {
				ADDRESS_STREET_NAME, ADDRESS_NUMBER, ADDRESS_AREA,
				ADDRESS_CITY, ADDRESS_ZIP, ADDRESS_COUNTRY, }, ADDRESS_ID
	...
	public Shop getShop(int id) {
		...
		Cursor cursor = db.query(TABLE_SHOP, new String[] { SHOP_NAME,
				SHOP_ADDRESS, SHOP_DESCRIPTION, }, SHOP_ID + "=?",
				new String[] { String.valueOf(id) }, null, null, null, null);
		if (cursor != null)
			cursor.moveToFirst();
	 ...
	 * " TEXT NOT NULL," + "FOREIGN KEY("+BUYS_PRODUCT+") REFERENCES "+
	...
	public void addBuys(Buys buys) {
		...
		values.put(BUYS_PRODUCT_GROUP_ID, buys.getGroup());
	...
	public Buys getBuys(int id) {
		...
		Cursor cursor = db.query(TABLE_BUYS, new String[] { BUYS_PRODUCT,
				BUYS_SHOP, BUYS_UNIT_PRICE, BUYS_AMOUNT, BUYS_DATE,
				BUYS_PRODUCT_GROUP_ID, }, BUYS_ID + "=?",
				new String[] { String.valueOf(id) }, null, null, null, null);
		if (cursor != null)
			cursor.moveToFirst();
