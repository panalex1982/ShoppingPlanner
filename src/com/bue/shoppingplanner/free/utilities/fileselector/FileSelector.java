package com.bue.shoppingplanner.free.utilities.fileselector;
...
public class FileSelector {
	...
	private void prepareFilterSpinner(String[] fitlesFilter) {
		...
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(mContext, R.layout.spinner_item_file_selector, fitlesFilter);
	...
	private void openNewFolderDialog() {
		...
		alert.setMessage(R.string.new_folder);
		...
		alert.setPositiveButton(R.string.create, new DialogInterface.OnClickListener() {
			...
			public void onClick(final DialogInterface dialog, final int whichButton) {
				...
				if (file.mkdir()) {
					Toast t = Toast.makeText(mContext, R.string.folder_created, Toast.LENGTH_SHORT);
					t.setGravity(Gravity.CENTER, 0, 0);
					t.show();
				} else {
					Toast t = Toast.makeText(mContext, R.string.folder_error, Toast.LENGTH_SHORT);
					t.setGravity(Gravity.CENTER, 0, 0);
					t.show();
				}
				String fileFilter = ((TextView) mFilterSpinner.getSelectedView()).getText().toString();
